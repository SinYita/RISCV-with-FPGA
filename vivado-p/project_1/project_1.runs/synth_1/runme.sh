...
HD_PWD='D:/FPGA/RISCV-with-FPGA/vivado-p/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rv_pl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rv_pl.tcl
