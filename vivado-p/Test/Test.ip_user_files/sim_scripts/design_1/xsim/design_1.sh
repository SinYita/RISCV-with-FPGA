...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto -L xil_defaultlib -L blk_mem_gen_v8_4_5 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot design_1 xil_defaultlib.design_1 xil_defaultlib.glbl -log elaborate.log
}
...
{
  file="xsim.ini"
  lib_map_path="/var/tmp/dwe_vivado_inst/Vivado/2021.2/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
