...
module design_1
  ...
  wire rv_pl_0_m_data_axi_ARREADY;
  wire rv_pl_0_m_data_axi_ARVALID;
  wire [31:0]rv_pl_0_m_data_axi_AWADDR;
  wire rv_pl_0_m_data_axi_AWREADY;
  wire rv_pl_0_m_data_axi_AWVALID;
  wire rv_pl_0_m_data_axi_BREADY;
  wire [1:0]rv_pl_0_m_data_axi_BRESP;
  wire rv_pl_0_m_data_axi_BVALID;
  wire [31:0]rv_pl_0_m_data_axi_RDATA;
  wire rv_pl_0_m_data_axi_RREADY;
  wire [1:0]rv_pl_0_m_data_axi_RRESP;
  wire rv_pl_0_m_data_axi_RVALID;
  wire [31:0]rv_pl_0_m_data_axi_WDATA;
  wire rv_pl_0_m_data_axi_WREADY;
  wire [3:0]rv_pl_0_m_data_axi_WSTRB;
  wire rv_pl_0_m_data_axi_WVALID;
  wire [31:0]rv_pl_0_m_inst_axi_ARADDR;
  wire rv_pl_0_m_inst_axi_ARREADY;
  wire rv_pl_0_m_inst_axi_ARVALID;
  wire [31:0]rv_pl_0_m_inst_axi_RDATA;
  wire rv_pl_0_m_inst_axi_RREADY;
  wire [1:0]rv_pl_0_m_inst_axi_RRESP;
  wire rv_pl_0_m_inst_axi_RVALID;
  ...
  design_1_axi_smc_2 axi_smc
       (.M00_AXI_araddr(axi_smc_M00_AXI_ARADDR),
        ...
        .S01_AXI_araddr(rv_pl_0_m_data_axi_ARADDR),
        .S01_AXI_arprot({1'b0,1'b0,1'b0}),
        .S01_AXI_arready(rv_pl_0_m_data_axi_ARREADY),
        .S01_AXI_arvalid(rv_pl_0_m_data_axi_ARVALID),
        .S01_AXI_awaddr(rv_pl_0_m_data_axi_AWADDR),
        .S01_AXI_awprot({1'b0,1'b0,1'b0}),
        .S01_AXI_awready(rv_pl_0_m_data_axi_AWREADY),
        .S01_AXI_awvalid(rv_pl_0_m_data_axi_AWVALID),
        .S01_AXI_bready(rv_pl_0_m_data_axi_BREADY),
        .S01_AXI_bresp(rv_pl_0_m_data_axi_BRESP),
        .S01_AXI_bvalid(rv_pl_0_m_data_axi_BVALID),
        .S01_AXI_rdata(rv_pl_0_m_data_axi_RDATA),
        .S01_AXI_rready(rv_pl_0_m_data_axi_RREADY),
        .S01_AXI_rresp(rv_pl_0_m_data_axi_RRESP),
        .S01_AXI_rvalid(rv_pl_0_m_data_axi_RVALID),
        .S01_AXI_wdata(rv_pl_0_m_data_axi_WDATA),
        .S01_AXI_wready(rv_pl_0_m_data_axi_WREADY),
        .S01_AXI_wstrb(rv_pl_0_m_data_axi_WSTRB),
        .S01_AXI_wvalid(rv_pl_0_m_data_axi_WVALID),
        .S02_AXI_araddr(rv_pl_0_m_inst_axi_ARADDR),
        .S02_AXI_arprot({1'b0,1'b0,1'b0}),
        .S02_AXI_arready(rv_pl_0_m_inst_axi_ARREADY),
        .S02_AXI_arvalid(rv_pl_0_m_inst_axi_ARVALID),
        .S02_AXI_rdata(rv_pl_0_m_inst_axi_RDATA),
        .S02_AXI_rready(rv_pl_0_m_inst_axi_RREADY),
        .S02_AXI_rresp(rv_pl_0_m_inst_axi_RRESP),
        .S02_AXI_rvalid(rv_pl_0_m_inst_axi_RVALID),
  ...
  design_1_rv_pl_0_1 rv_pl_0
       (.clk(processing_system7_0_FCLK_CLK0),
        .m_data_axi_araddr(rv_pl_0_m_data_axi_ARADDR),
        .m_data_axi_arready(rv_pl_0_m_data_axi_ARREADY),
        .m_data_axi_arvalid(rv_pl_0_m_data_axi_ARVALID),
        .m_data_axi_awaddr(rv_pl_0_m_data_axi_AWADDR),
        .m_data_axi_awready(rv_pl_0_m_data_axi_AWREADY),
        .m_data_axi_awvalid(rv_pl_0_m_data_axi_AWVALID),
        .m_data_axi_bready(rv_pl_0_m_data_axi_BREADY),
        .m_data_axi_bresp(rv_pl_0_m_data_axi_BRESP),
        .m_data_axi_bvalid(rv_pl_0_m_data_axi_BVALID),
        .m_data_axi_rdata(rv_pl_0_m_data_axi_RDATA),
        .m_data_axi_rready(rv_pl_0_m_data_axi_RREADY),
        .m_data_axi_rresp(rv_pl_0_m_data_axi_RRESP),
        .m_data_axi_rvalid(rv_pl_0_m_data_axi_RVALID),
        .m_data_axi_wdata(rv_pl_0_m_data_axi_WDATA),
        .m_data_axi_wready(rv_pl_0_m_data_axi_WREADY),
        .m_data_axi_wstrb(rv_pl_0_m_data_axi_WSTRB),
        .m_data_axi_wvalid(rv_pl_0_m_data_axi_WVALID),
        .m_inst_axi_araddr(rv_pl_0_m_inst_axi_ARADDR),
        .m_inst_axi_arready(rv_pl_0_m_inst_axi_ARREADY),
        .m_inst_axi_arvalid(rv_pl_0_m_inst_axi_ARVALID),
        .m_inst_axi_rdata(rv_pl_0_m_inst_axi_RDATA),
