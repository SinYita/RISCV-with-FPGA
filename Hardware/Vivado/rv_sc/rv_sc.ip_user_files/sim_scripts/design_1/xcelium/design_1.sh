...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../bd/design_1/ipshared/baed/rv_sc" \
       +incdir+"../../../../rv_sc.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"../../../../rv_sc.gen/sources_1/bd/design_1/ipshared/3007/hdl" \
       +incdir+"../../../../rv_sc.gen/sources_1/bd/design_1/ipshared/baed/rv_sc" \
       +incdir+"../../../../rv_sc.gen/sources_1/bd/design_1/ipshared/f0b6/hdl/verilog" \
       +incdir+"../../../../rv_sc.gen/sources_1/bd/design_1/ipshared/66be/hdl/verilog" \
       +incdir+"/var/tmp/dwe_vivado_inst/Vivado/2021.2/data/xilinx_vip/include"
}
