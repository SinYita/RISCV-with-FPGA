...
module design_1
  ...
  wire rv_single_axi_0_done;
  wire [31:0]rv_single_axi_0_m_data_axi_ARADDR;
  wire [2:0]rv_single_axi_0_m_data_axi_ARPROT;
  wire rv_single_axi_0_m_data_axi_ARREADY;
  wire rv_single_axi_0_m_data_axi_ARVALID;
  wire [31:0]rv_single_axi_0_m_data_axi_AWADDR;
  wire [2:0]rv_single_axi_0_m_data_axi_AWPROT;
  wire rv_single_axi_0_m_data_axi_AWREADY;
  wire rv_single_axi_0_m_data_axi_AWVALID;
  wire rv_single_axi_0_m_data_axi_BREADY;
  wire [1:0]rv_single_axi_0_m_data_axi_BRESP;
  wire rv_single_axi_0_m_data_axi_BVALID;
  wire [31:0]rv_single_axi_0_m_data_axi_RDATA;
  wire rv_single_axi_0_m_data_axi_RREADY;
  wire [1:0]rv_single_axi_0_m_data_axi_RRESP;
  wire rv_single_axi_0_m_data_axi_RVALID;
  wire [31:0]rv_single_axi_0_m_data_axi_WDATA;
  wire rv_single_axi_0_m_data_axi_WREADY;
  wire [3:0]rv_single_axi_0_m_data_axi_WSTRB;
  wire rv_single_axi_0_m_data_axi_WVALID;
  wire [31:0]rv_single_axi_0_m_inst_axi_ARADDR;
  wire [2:0]rv_single_axi_0_m_inst_axi_ARPROT;
  wire rv_single_axi_0_m_inst_axi_ARREADY;
  wire rv_single_axi_0_m_inst_axi_ARVALID;
  wire [31:0]rv_single_axi_0_m_inst_axi_RDATA;
  wire rv_single_axi_0_m_inst_axi_RREADY;
  wire [1:0]rv_single_axi_0_m_inst_axi_RRESP;
  wire rv_single_axi_0_m_inst_axi_RVALID;

  assign done_0 = rv_single_axi_0_done;
  ...
  design_1_axi_gpio_0_0 axi_gpio_0
       (.gpio2_io_o(axi_gpio_0_gpio2_io_o),
        .gpio_io_i(rv_single_axi_0_done),
        .s_axi_aclk(processing_system7_0_FCLK_CLK0),
  ...
  design_1_axi_smc_2 axi_smc
       (.M00_AXI_araddr(axi_smc_M00_AXI_ARADDR),
        ...
        .S01_AXI_araddr(rv_single_axi_0_m_data_axi_ARADDR),
        .S01_AXI_arprot(rv_single_axi_0_m_data_axi_ARPROT),
        .S01_AXI_arready(rv_single_axi_0_m_data_axi_ARREADY),
        .S01_AXI_arvalid(rv_single_axi_0_m_data_axi_ARVALID),
        .S01_AXI_awaddr(rv_single_axi_0_m_data_axi_AWADDR),
        .S01_AXI_awprot(rv_single_axi_0_m_data_axi_AWPROT),
        .S01_AXI_awready(rv_single_axi_0_m_data_axi_AWREADY),
        .S01_AXI_awvalid(rv_single_axi_0_m_data_axi_AWVALID),
        .S01_AXI_bready(rv_single_axi_0_m_data_axi_BREADY),
        .S01_AXI_bresp(rv_single_axi_0_m_data_axi_BRESP),
        .S01_AXI_bvalid(rv_single_axi_0_m_data_axi_BVALID),
        .S01_AXI_rdata(rv_single_axi_0_m_data_axi_RDATA),
        .S01_AXI_rready(rv_single_axi_0_m_data_axi_RREADY),
        .S01_AXI_rresp(rv_single_axi_0_m_data_axi_RRESP),
        .S01_AXI_rvalid(rv_single_axi_0_m_data_axi_RVALID),
        .S01_AXI_wdata(rv_single_axi_0_m_data_axi_WDATA),
        .S01_AXI_wready(rv_single_axi_0_m_data_axi_WREADY),
        .S01_AXI_wstrb(rv_single_axi_0_m_data_axi_WSTRB),
        .S01_AXI_wvalid(rv_single_axi_0_m_data_axi_WVALID),
        .S02_AXI_araddr(rv_single_axi_0_m_inst_axi_ARADDR),
        .S02_AXI_arprot(rv_single_axi_0_m_inst_axi_ARPROT),
        .S02_AXI_arready(rv_single_axi_0_m_inst_axi_ARREADY),
        .S02_AXI_arvalid(rv_single_axi_0_m_inst_axi_ARVALID),
        .S02_AXI_rdata(rv_single_axi_0_m_inst_axi_RDATA),
        .S02_AXI_rready(rv_single_axi_0_m_inst_axi_RREADY),
        .S02_AXI_rresp(rv_single_axi_0_m_inst_axi_RRESP),
        .S02_AXI_rvalid(rv_single_axi_0_m_inst_axi_RVALID),
  ...
  design_1_rv_single_axi_0_0 rv_single_axi_0
       (.clk(processing_system7_0_FCLK_CLK0),
        .done(rv_single_axi_0_done),
        .m_data_axi_araddr(rv_single_axi_0_m_data_axi_ARADDR),
        .m_data_axi_arprot(rv_single_axi_0_m_data_axi_ARPROT),
        .m_data_axi_arready(rv_single_axi_0_m_data_axi_ARREADY),
        .m_data_axi_arvalid(rv_single_axi_0_m_data_axi_ARVALID),
        .m_data_axi_awaddr(rv_single_axi_0_m_data_axi_AWADDR),
        .m_data_axi_awprot(rv_single_axi_0_m_data_axi_AWPROT),
        .m_data_axi_awready(rv_single_axi_0_m_data_axi_AWREADY),
        .m_data_axi_awvalid(rv_single_axi_0_m_data_axi_AWVALID),
        .m_data_axi_bready(rv_single_axi_0_m_data_axi_BREADY),
        .m_data_axi_bresp(rv_single_axi_0_m_data_axi_BRESP),
        .m_data_axi_bvalid(rv_single_axi_0_m_data_axi_BVALID),
        .m_data_axi_rdata(rv_single_axi_0_m_data_axi_RDATA),
        .m_data_axi_rready(rv_single_axi_0_m_data_axi_RREADY),
        .m_data_axi_rresp(rv_single_axi_0_m_data_axi_RRESP),
        .m_data_axi_rvalid(rv_single_axi_0_m_data_axi_RVALID),
        .m_data_axi_wdata(rv_single_axi_0_m_data_axi_WDATA),
        .m_data_axi_wready(rv_single_axi_0_m_data_axi_WREADY),
        .m_data_axi_wstrb(rv_single_axi_0_m_data_axi_WSTRB),
        .m_data_axi_wvalid(rv_single_axi_0_m_data_axi_WVALID),
        .m_inst_axi_araddr(rv_single_axi_0_m_inst_axi_ARADDR),
        .m_inst_axi_arprot(rv_single_axi_0_m_inst_axi_ARPROT),
        .m_inst_axi_arready(rv_single_axi_0_m_inst_axi_ARREADY),
        .m_inst_axi_arvalid(rv_single_axi_0_m_inst_axi_ARVALID),
        .m_inst_axi_rdata(rv_single_axi_0_m_inst_axi_RDATA),
        .m_inst_axi_rready(rv_single_axi_0_m_inst_axi_RREADY),
        .m_inst_axi_rresp(rv_single_axi_0_m_inst_axi_RRESP),
        .m_inst_axi_rvalid(rv_single_axi_0_m_inst_axi_RVALID),
